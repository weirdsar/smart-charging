...
/**
 * Homepage hero — files under `public/content/`. Appends `?v=<short git sha>` on Vercel so edge
 * cache does not keep serving an older file after replacing images with the same name.
 */
const heroCacheBust =
