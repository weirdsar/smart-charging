...
export const metadata: Metadata = {
  title: 'Зарядные станции для электромобилей Pandora — купить в Саратове | Умная зарядка',
  description:
    'Домашние и коммерческие зарядные станции Pandora для электромобилей. Установка «под ключ» в Саратове и области.',
  alternates: {
    canonical: '/catalog/charging-stations',
  },
};
...
export default async function ChargingStationsPage({
  ...
  const data = await getCategoryListing('CHARGING_STATIONS', searchParams);
    ...
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      <div className="mb-8 mt-6">
        ...
        <p className="text-text-secondary">
          Зарядные станции Pandora для дома, бизнеса и общественной инфраструктуры
        </p>
      </div>
      ...
      <div className="lg:grid lg:grid-cols-[280px_1fr] lg:gap-8">
        <aside className="mb-6 lg:mb-0">
          ...
          >
            <CatalogFiltersColumn showAvrFilter={false} />
          </Suspense>
        </aside>
        ...
        <div>
          ...
          <ProductGrid products={products} categoryPath="charging-stations" />
